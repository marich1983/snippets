from django.forms import ModelForm, ValidationError, Textarea, TextInput, CheckboxInput, CharField, PasswordInput
...
class SnippetForm(ModelForm):
    class Meta:
       ...
       labels = {'name': '', "lang": '', "code": '', "public": 'Public/Private'}
       widgets = {
